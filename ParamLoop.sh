...
for combination in $combinations; do
  ...
  sbatch --mail-user=$email \
          --mail-type=$mailtype \
          --job-name=$slurm_name \
          --output=$output_directory/${slurm_name}_${param1_placeholder,,}${i}_${param2_placeholder,,}${j}_%j.out \
          --error=$output_directory/errors/${slurm_name}_${param1_placeholder,,}${i}_${param2_placeholder,,}${j}_%j.err \
