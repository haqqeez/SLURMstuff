...
do
	...
	then
		...
		then
			...
			cp /lustre03/project/rpp-markpb68/m3group/Haqqee/GitHub/SLURMstuff/minitouchsync_PI.sl .
			cp /lustre03/project/rpp-markpb68/m3group/Haqqee/GitHub/SLURMstuff/minitouchsync_PI.m .
			...
			ID="$touch-$ID-$date" 
			sleep 2
			sed -i -e "s/TASKNAME/$ID/g" minitouchsync_PI.sl
			sed -i -e "s/MYEMAIL/$email/g" minitouchsync_PI.sl
			sbatch minitouchsync_PI.sl
			sleep 2
		else
